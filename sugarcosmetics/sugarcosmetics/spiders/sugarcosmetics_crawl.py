...
class SugarcosmeticsCrawlSpider(scrapy.Spider):
    ...
    def api(self, response):
        ...
        page = 0
        skip = 0
        self.json_data['collection_handle'] = collection
        apiurl = 'https://prod.api.sugarcosmetics.com/collections/prod/getCollectionv2'
        yield scrapy.Request(apiurl, headers=self.headers, method='POST', body=json.dumps(self.json_data), dont_filter=True, callback=self.listpage, meta={'page':page, 'skip':skip})
